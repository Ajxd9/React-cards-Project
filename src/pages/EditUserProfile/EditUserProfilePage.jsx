...
import normalizeFromServer from "../ProfilePage/normalizeFromServer";
import { validateSchema } from "../../validation/registerValidation";
import EditNoteIcon from "@mui/icons-material/EditNote";
import TextInputComp from "../../components/TextFieldComponent";
...
const EditUserProfilePage = () => {
  ...
  useEffect(() => {
    const handleUpdateDetails = async () => {
      try {
        let { data } = await axios.get("/users/" + login.user._id);
